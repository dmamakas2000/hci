...
public class SteelCheckBoxUI extends javax.swing.plaf.basic.BasicCheckBoxUI
    ...
    private java.awt.image.BufferedImage backgroundImage = create_BACKGROUND_Image( SteelCheckBoxUI.SIZE.width );
    private java.awt.image.BufferedImage knobStandardImage = create_KNOB_Image( SteelCheckBoxUI.SIZE.height, false );
    private java.awt.image.BufferedImage knobPressedImage = create_KNOB_Image( SteelCheckBoxUI.SIZE.height, true );
    ...
    private void init() {
        this.foreground = new java.awt.geom.RoundRectangle2D.Double(
                ...
                this.pos.y + this.backgroundImage.getHeight() * 0.0714285746216774,
                this.backgroundImage.getWidth() * 0.923076868057251, this.backgroundImage.getHeight() * 0.8571428060531616,
                this.backgroundImage.getHeight() * 0.8571428571, this.backgroundImage.getHeight() * 0.8571428571 );
        this.foregroundStart = new java.awt.geom.Point2D.Double( this.pos.x, this.foreground.getBounds2D().getMinY() );
        this.foregroundStop = new java.awt.geom.Point2D.Double( this.pos.x, this.foreground.getBounds2D().getMaxY() );
        this.foregroundGradient = new java.awt.LinearGradientPaint( this.foregroundStart, this.foregroundStop,
                this.FOREGROUND_FRACTIONS, this.foregroundColors );
    }
    ...
    public synchronized void paint( final java.awt.Graphics g, final javax.swing.JComponent component ) {
        ...
        this.pos.setLocation( 0, ( this.CHECKBOX.getPreferredSize().height - SteelCheckBoxUI.SIZE.height ) / 2.0 );
        ...
        // Draw the background
        G2.drawImage( this.backgroundImage, this.pos.x, this.pos.y, null );

        // Draw the foreground and knob
        if ( this.CHECKBOX.isSelected() ) {
            if ( this.CHECKBOX.isColored() ) {
                if ( this.CHECKBOX.isRised() ) {
                    this.foregroundColors = new java.awt.Color[] {

                            this.CHECKBOX.getSelectedColor().LIGHT.brighter(), this.CHECKBOX.getSelectedColor().LIGHT,
                            this.CHECKBOX.getSelectedColor().MEDIUM, this.CHECKBOX.getSelectedColor().DARK };
                }
                else {
                    this.foregroundColors = new java.awt.Color[] { this.CHECKBOX.getSelectedColor().DARK,
                            this.CHECKBOX.getSelectedColor().DARK, this.CHECKBOX.getSelectedColor().LIGHT,
                            this.CHECKBOX.getSelectedColor().MEDIUM };
                }
            }
            else {
                this.foregroundColors = new java.awt.Color[] { new java.awt.Color( 241, 242, 242, 255 ),
                        new java.awt.Color( 224, 225, 226, 255 ), new java.awt.Color( 166, 169, 171, 255 ),
            ...
            if ( this.mouseOver && this.mousePressed ) {
                G2.drawImage( this.knobPressedImage, this.pos.x + this.backgroundImage.getWidth() / 2, this.pos.y, null );
            }
            else {
                G2.drawImage( this.knobStandardImage, this.pos.x + this.backgroundImage.getWidth() / 2, this.pos.y, null );
            }
        }
        else {
            if ( this.mouseOver && this.mousePressed ) {
                G2.drawImage( this.knobPressedImage, this.pos.x, this.pos.y, null );
            }
            else {
                G2.drawImage( this.knobStandardImage, this.pos.x, this.pos.y, null );
            }
        }
        ...
        final java.awt.font.TextLayout TEXT_LAYOUT = new java.awt.font.TextLayout( this.CHECKBOX.getText(), G2.getFont(),
                RENDER_CONTEXT );
        final java.awt.geom.Rectangle2D BOUNDS = TEXT_LAYOUT.getBounds();
        G2.drawString( this.CHECKBOX.getText(), this.backgroundImage.getWidth() + 5,
                ( this.CHECKBOX.getBounds().height - BOUNDS.getBounds().height ) / 2 + BOUNDS.getBounds().height );
    ...
    private java.awt.image.BufferedImage create_KNOB_Image( final int WIDTH, final boolean PRESSED ) {
        ...
        final java.awt.geom.Ellipse2D KNOB_FRAME = new java.awt.geom.Ellipse2D.Double( IMAGE_WIDTH * 0.0, IMAGE_HEIGHT * 0.0,
        ...
        final java.awt.Color[] KNOB_FRAME_COLORS = { new java.awt.Color( 90, 91, 92, 255 ), new java.awt.Color( 127, 127, 128, 255 ),
                new java.awt.Color( 81, 82, 83, 255 ), new java.awt.Color( 104, 105, 105, 255 ),
                new java.awt.Color( 63, 64, 65, 255 ) };
        if ( KNOB_FRAME_START.distance( KNOB_FRAME_STOP ) > 0 ) {
            final java.awt.LinearGradientPaint KNOB_FRAME_GRADIENT = new java.awt.LinearGradientPaint( KNOB_FRAME_START,
                    KNOB_FRAME_STOP, E_KNOB_FRAME_FRACTIONS, KNOB_FRAME_COLORS );
            G2.setPaint( KNOB_FRAME_GRADIENT );
            G2.fill( KNOB_FRAME );
        }

        final java.awt.geom.Ellipse2D KNOB = new java.awt.geom.Ellipse2D.Double( IMAGE_WIDTH * 0.07692307978868484,
                IMAGE_HEIGHT * 0.07692307978868484, IMAGE_WIDTH * 0.8461538553237915, IMAGE_HEIGHT * 0.8461538553237915 );
        ...
        if ( PRESSED ) {
            KNOB_COLORS = new java.awt.Color[] { new java.awt.Color( 0xC2C2C2 ), new java.awt.Color( 0x727678 ),
                    new java.awt.Color( 0xC2C2C2 ), new java.awt.Color( 0x727678 ), new java.awt.Color( 0xC2C2C2 ),
                    new java.awt.Color( 0x727678 ), new java.awt.Color( 0xC2C2C2 ) };
        }
        else {
            KNOB_COLORS = new java.awt.Color[] { new java.awt.Color( 0xF2F2F2 ), new java.awt.Color( 0x8F9396 ),
                    new java.awt.Color( 0xF2F2F2 ), new java.awt.Color( 0x8F9396 ), new java.awt.Color( 0xF2F2F2 ),
    ...
    private java.awt.image.BufferedImage create_BACKGROUND_Image( final int WIDTH ) {
        ...
        final java.awt.GraphicsConfiguration GFX_CONF = java.awt.GraphicsEnvironment.getLocalGraphicsEnvironment()
                .getDefaultScreenDevice().getDefaultConfiguration();
        final java.awt.image.BufferedImage IMAGE = GFX_CONF.createCompatibleImage( WIDTH, ( int ) ( 0.5384615384615384 * WIDTH ),
        ...
        final java.awt.geom.RoundRectangle2D BACKGROUND_FRAME = new java.awt.geom.RoundRectangle2D.Double( IMAGE_WIDTH * 0.0,
                IMAGE_HEIGHT * 0.0, IMAGE_WIDTH * 1.0, IMAGE_HEIGHT * 1.0, IMAGE_HEIGHT, IMAGE_HEIGHT );
        final java.awt.geom.Point2D BACKGROUND_FRAME_START = new java.awt.geom.Point2D.Double( 0,
                BACKGROUND_FRAME.getBounds2D().getMinY() );
        final java.awt.geom.Point2D BACKGROUND_FRAME_STOP = new java.awt.geom.Point2D.Double( 0,
                BACKGROUND_FRAME.getBounds2D().getMaxY() );
        final float[] BACKGROUND_FRAME_FRACTIONS = { 0.0f, 0.51f, 1.0f };
        final java.awt.Color[] BACKGROUND_FRAME_COLORS = { new java.awt.Color( 68, 68, 68, 255 ),
                new java.awt.Color( 105, 105, 106, 255 ), new java.awt.Color( 216, 217, 218, 255 ) };
        final java.awt.LinearGradientPaint BACKGROUND_FRAME_GRADIENT = new java.awt.LinearGradientPaint( BACKGROUND_FRAME_START,
                BACKGROUND_FRAME_STOP, BACKGROUND_FRAME_FRACTIONS, BACKGROUND_FRAME_COLORS );
        G2.setPaint( BACKGROUND_FRAME_GRADIENT );
        G2.fill( BACKGROUND_FRAME );

        final java.awt.geom.RoundRectangle2D BACKGROUND = new java.awt.geom.RoundRectangle2D.Double( IMAGE_WIDTH * 0.03846153989434242,
                IMAGE_HEIGHT * 0.0714285746216774, IMAGE_WIDTH * 0.923076868057251, IMAGE_HEIGHT * 0.8571428060531616, IMAGE_HEIGHT,
                IMAGE_HEIGHT );
        ...
        final java.awt.Color[] BACKGROUND_COLORS = { new java.awt.Color( 91, 91, 91, 255 ), new java.awt.Color( 138, 138, 138, 255 ),
                new java.awt.Color( 124, 124, 124, 255 ) };
        if ( BACKGROUND_START.distance( BACKGROUND_STOP ) > 0 ) {
            final java.awt.LinearGradientPaint BACKGROUND_GRADIENT = new java.awt.LinearGradientPaint( BACKGROUND_START,
                    BACKGROUND_STOP, BACKGROUND_FRACTIONS, BACKGROUND_COLORS );
    ...
    public void componentResized( final java.awt.event.ComponentEvent EVENT ) {
        init();
        this.pos.setLocation( 0, ( EVENT.getComponent().getHeight() - SteelCheckBoxUI.SIZE.height ) / 2.0 );
    }
